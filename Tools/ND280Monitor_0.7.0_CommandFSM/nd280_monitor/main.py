...
class MainWindow(QMainWindow):
    def __init__(self) -> None:
        super().__init__()
        self.setWindowTitle("ND280 Magnetic Field Monitor 0.7.0")
    ...
    def _build_ui(self) -> None:
        ...
        console_header.addWidget(QLabel("Serial console"))
        console_header.addStretch()
        self.clear_console_button = QPushButton("Clear serial console")
        self.clear_console_button.clicked.connect(self.clear_serial_console)
    ...
    def clear_serial_console(self) -> None:
        self.console.clear()
        self.statusBar().showMessage("Serial console cleared", 2000)
