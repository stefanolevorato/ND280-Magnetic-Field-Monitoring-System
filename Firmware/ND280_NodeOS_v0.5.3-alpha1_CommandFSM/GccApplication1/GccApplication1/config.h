 ...
 * NodeOS identity
 * ------------------------------------------------------------------------- */
#define NODEOS_VERSION        "0.5.3-alpha1"
...
/* -------------------------------------------------------------------------
 * Deterministic command parser. Commands must start with ':' and end with
 * CR or LF. All other incoming bytes are ignored.
 * ------------------------------------------------------------------------- */
#define COMMAND_START_CHARACTER ':'
#define COMMAND_MAX_LENGTH 48U
